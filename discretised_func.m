...
% returns the discretised verision of Equation (2.31)
...
g(i) = 1/(2*q(i)*s_old*dz)*(k(i)*(1/q(i)-a(i)) - k(i-1)*(1/q(i-1)-a(i-1))) ...
    + k(i)*(1/q(i)-a(i)) ...
    + (k(i)/(4*q(i))*(1/q(i)*(a(i)-a(i-1)) - 1/q(i-1)*(a(i)-a(i-1)) ) ...
    + 1/(4*q(i)^2)*(a(i)-a(i-1))*(k(i)-k(i-1)) ...
    + a(i)/(4*q(i))*(1/q(i)*(k(i)-k(i-1)) - 1/q(i-1)*(k(i)-k(i-1)) ) )*1/(s_old^2*dz^2);
